    ...
    <div class="hero_area">
        ...
        <section class="slider_section">
            ...
            <div id="customCarousel1" class="carousel slide" data-ride="carousel">
                ...
                $sliderresult = mysqli_query($conn, $sliderquery) or exit("slider select fail" . mysqli_error($conn));
                $isFirst = true;
                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6">
                                    <div class="detail-box2">
                                        <h1 class="slide-name">
                                            <?php echo $sliderrow['name']; ?>
                                        </h1>
                                        <h1 class="slide_name2">
                                            <?php echo $sliderrow['name2']; ?>
                                        </h1>
                                        <p class="slide-description">
                                            <?php echo $sliderrow['description']; ?>
                                        </p>
                                        <div class="btn-box2">
                                            <a href="product.php <?php echo $sliderrow['button_link']; ?>" class="btn1">
                                                Shop Now
                                            </a>
                                        </div>
                                    </div>
                ...
                <!-- Carousel controls -->
                <a class="carousel-control-next" href="#customCarousel1" role="button" data-slide="prev">
                    <span class="carousel-control-next-icon " aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                </a>
                <a class=" carousel-control-prev" href="#customCarousel1" role="button" data-slide="next">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="box">
                        ...
                        <div class="">
                            <h5>Fast Delivery</h5>
                            <p>products sold will come quickly</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="box">
                        ...
                        <div class="">
                            <h5>Best Quality</h5>
                            <p>The Good Sold are the Good Quality</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
    ...
    <section class="product_section layout_padding">
        <div class="container">
            ...
            <div class="row">
                ...
                $productqry = "select * from products order by id desc limit 6";
